...
Svc::Health::PingEntry pingEntries[] = {
    {PingEntries::MainDeployment_blockDrv::WARN, PingEntries::MainDeployment_blockDrv::FATAL, "blockDrv"},
    {PingEntries::MainDeployment_tlmSend::WARN, PingEntries::MainDeployment_tlmSend::FATAL, "chanTlm"},
    {PingEntries::MainDeployment_cmdDisp::WARN, PingEntries::MainDeployment_cmdDisp::FATAL, "cmdDisp"},
    {PingEntries::MainDeployment_cmdSeq::WARN, PingEntries::MainDeployment_cmdSeq::FATAL, "cmdSeq"},
    {PingEntries::MainDeployment_eventLogger::WARN, PingEntries::MainDeployment_eventLogger::FATAL, "eventLogger"},
    {PingEntries::MainDeployment_fileDownlink::WARN, PingEntries::MainDeployment_fileDownlink::FATAL, "fileDownlink"},
    {PingEntries::MainDeployment_fileManager::WARN, PingEntries::MainDeployment_fileManager::FATAL, "fileManager"},
    {PingEntries::MainDeployment_fileUplink::WARN, PingEntries::MainDeployment_fileUplink::FATAL, "fileUplink"},
    {PingEntries::MainDeployment_prmDb::WARN, PingEntries::MainDeployment_prmDb::FATAL, "prmDb"},
    {PingEntries::MainDeployment_rateGroup1::WARN, PingEntries::MainDeployment_rateGroup1::FATAL, "rateGroup1"},
    {PingEntries::MainDeployment_rateGroup2::WARN, PingEntries::MainDeployment_rateGroup2::FATAL, "rateGroup2"},
    {PingEntries::MainDeployment_rateGroup3::WARN, PingEntries::MainDeployment_rateGroup3::FATAL, "rateGroup3"},
};
