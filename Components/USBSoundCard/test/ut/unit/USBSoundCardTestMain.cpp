// ======================================================================
// \title  USBSoundCardTestMain.cpp
// \author root
// \brief  Main test file for USBSoundCard component
// ======================================================================
...
int main(int argc, char* argv[]) {
    ...
    std::cout << "=== USBSoundCard Component Tests ===" << std::endl;
    
    try {
        // Run unit tests
        std::cout << "\n--- Running Unit Tests ---" << std::endl;
        Components::USBSoundCardTester tester;
        tester.runTests();
        
        // Run integration tests (disabled for now due to initialization issues)
